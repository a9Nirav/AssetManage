        ...
        <>
            ...
            <div className='right-content w-100'>
                ...
                <div className="card shadow border-0 w-100 flex-row p-4 res-col d-flex justify-content-between">
                    <h5 className='mb-0 d-flex align-items-center'>Insurance Entry Table</h5>
                    <Link to="/Transactions/InsuranceEntry">
...
export default InsuranceEntryTable
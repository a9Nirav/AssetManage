...
import { MdDelete, MdOutlineSignalCellularConnectedNoInternet4Bar } from "react-icons/md";
import { useForm, Controller } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { FaUpload } from "react-icons/fa6";
import CustomInput from "../../components/CustomInput/CustomInput";
import { step1Schema, step2Schema } from "../../features/validationSchemas";
...
const PurchaseOrder = () => {
    const steps = ["Basic Info", "Add Items", "Payment Info"];
    ...
    const [subToal, setSubTotal] = useState();
    const [shppingCost, setShppingCost] = useState("");
    const [tax, setTax] = useState("");
    // const [salesTax, setSalestax] = useState("");
    const [adj,setAdj]=useState("")

    const handelTotal = (e) => {
        setShppingCost(e.target.value);
    ...
    const  salesTax = tax/subToal*100;
    console.log(salesTax)
    const ans = Number(subToal) + Number(shppingCost)+Number(salesTax);
    ...
    const handleAdd = () => {
        ...
        console.log(itemData.cost * itemData.quantity)
        ...
        <>
            ...
            <div className='right-content'>
                ...
                <div className="card shadow border-0 p-4 mt-3">
                    ...
                    <div sx={{ maxWidth: 600, mx: "auto", mt: 5 }}>
                        ...
                        <form component="form" onSubmit={handleSubmit(onSubmit)} sx={{ mt: 4 }}>
                            {step === 0 && (
                                <>
                                    <div className="d-flex justify-between my-2">
                                        <div className="">User Name : <b>Admin</b></div>
                                        <div className="">Previous PO #: <b>3456587</b></div>
                                    </div>
                                    <div className="row">
                                        <CustomInput label="PO Ref NO." name="PoRefNo" register={register} errors={errors} />

                                        <CustomInput label="Signing Authority" name="SigningAuthority" register={register} errors={errors} />
                                        <CustomInput label="PO Name" name="PoNo" register={register} errors={errors} />
                                        <CustomInput label="FAX" name="Fax" register={register} errors={errors} />
                                        <CustomInput label="Create Date" type='date' name="CreateDate" register={register} errors={errors} />
                                        ...
                                        <CustomInput label="Person Number" name="Phone" register={register} errors={errors} />
                                    ...
                                    <div className="row border p-4 bg-light">
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <label className="form-label mt-3">Division:<sup className="text-red-500">*</sup></label>
                                            <select
                                            ...
                                            <label className="form-label mt-3">Department:<sup className="text-red-500">*</sup></label>
                                            <select
                                        ...
                                        <div className="col-md-6">
                                            <label className="form-label ">Allocate To:<sup className="text-red-500">*</sup></label>
                                            <select
                            ...
                            {step === 1 && (
                                <>
                                    <div className="py-2">Vendor Name: <b>SUN IKON</b></div>
                                    <div className="row">
                                        <div className="col-md-3">
                                            <label className="form-label ">Items:<sup className="text-red-500">*</sup></label>
                                            <select
                                                className={`form-select form-control ${errors.Items ? "is-invalid" : ""}`}
                                                {...register("Items")} onChange={handleChange}
                                        ...
                                        <div className="col-md-3">
                                            <label className="form-label ">Item Cost:.RS<sup className="text-red-500">*</sup></label>
                                            <input type="text" className={`form-control ${errors.cost ? "is-invalid" : ""}`}
                                                {...register("cost")} onChange={handleChange}
                                                value={itemData.cost} placeholder="Item Cost" />
                                            <div className="invalid-feedback">{`cost  ${errors.cost?.message}`}</div>

                                        </div>

                                        <div className="col-md-3">
                                            <label className="form-label "> Quantity<sup className="text-red-500">*</sup></label>
                                            <input type="text" className={`form-control ${errors.quantity ? "is-invalid" : ""}`}
                                                {...register("quantity")} onChange={handleChange}
                                                value={itemData.quantity} placeholder="Enter quantity" />
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <div className="actions d-flex align-items-center">
                                                            <Button className="success" color="success" onClick={() => handleEdit(index)}>
                                                                <FaPencilAlt />
                                                            </Button>

                                                            <Button className="error" color="error" onClick={() => handleDelete(index)}><MdDelete /></Button>
                                                        </div>
                                                    </td>
                                                </tr>
                                    ...
                                    <div className="bg-light row p-3">
                                        <div className="col-md-6">
                                            ...
                                            <input type="text" className="form-control" value={subToal} />

                                            <label className="form-label mt-3">Shpping Cost (B) Rs.</label>
                                            <input type="text" className="form-control" value={shppingCost} onChange={handelTotal} placeholder="Enter Shpping Cost" />

                                            <label className="form-label mt-3">Tax:</label>
                                            <select
                                                className="form-select form-control"
                                                onChange={handelTotal} value={tax}
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input type="text" className="form-control"  onChange={handelTotal} />

                                            <label className="form-label mt-3"> - Price Adjustment (D) Rs.</label>
                                            <input type="text" className="form-control" onChange={handelTotal}  />

                                            <label className="form-label mt-3">Total Cost (A+B+C-D) Rs.</label>

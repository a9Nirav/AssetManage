    ...
    return (
        ...
        <div className="right-content">
            <div className="card shadow border-0 w-100 flex-row p-4 res-col d-flex justify-content-between">
                <h5 className='mb-0 d-flex align-items-center'>  Asset  Allocation Table</h5>
                <div className="">
                    <Link to="/Transactions/AssetAlloction">
...
export default ViewAssetAlloction
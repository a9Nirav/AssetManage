...
import logo  from "../../assets/nirav_vadhiya_img.jpeg"
                    ...
                    <div className="row d-flex align-items-center w-100">
                        ...
                        <div className="col-sm-2 part1">
                            <Link to={'/'} className="d-flex align-items-center logo">
                                ...
                                <span className="ml-2 color1">ADMIN</span>
                            </Link>
                        </div>
                        ...
                        <div className="col-sm-7 d-flex align-items-center justify-content-end part3">
                            <Button className="rounded-circle mr-3 me-2" onClick={changeTheme}>
                                <MdOutlineLightMode />
                            </Button>
                            ...
                            <div className='dropdownWrapper position-relative'>
                                <Button className="rounded-circle mr-3 me-1"
                                ...
                                >
                                    ...
                                    <div className='head pl-3 pb-0 p-2'>
                                        <h4>Orders (12)  </h4>
                                    </div>
                                    ...
                                    <div className="myAccWrapper">
                                        ...
                                        >
                                            ...
                                            <div className="userInfo res-hide">
                                                <h4 className='color1'>Rinku Verma</h4>
                                                <p className="mb-0 color1">@rinkuv37</p>
                                            </div>

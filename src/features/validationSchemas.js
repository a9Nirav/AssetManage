...
export const  SurveySchemas = yup.object().shape({
  ...
  Date: yup.date()
    .transform((value, originalValue) => (originalValue === "" ? null : value)),
  fromDate: yup.date().transform((value, originalValue) => (originalValue === "" ? null : value)).required("From date is required"),
  toDate: yup
    .date().transform((value, originalValue) => (originalValue === "" ? null : value))
    .required("To date is required")
    .min(yup.ref("fromDate"), "To date must be after From date"),
